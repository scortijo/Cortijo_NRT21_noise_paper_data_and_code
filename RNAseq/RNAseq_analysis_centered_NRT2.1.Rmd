...
my_colors <- RColorBrewer::brewer.pal(12, "Paired")[c(2,4,6,5,8,10)]
...
ggplot(CPM_SC18_all_WT_expr_Brennecke_data, aes(x=Mean, y=CV2)) +
  ...
  ylab(bquote(CV^2)) +
  geom_point(data=CPM_SC18_all_WT_expr_HVG,col="grey") +
 geom_point(data=CPM_SC18_all_WT_expr_Brennecke_genes_interest, aes(col=type),  size=5) +
  scale_color_manual(values = my_colors, name="Type of gene",
...
my_colors <- RColorBrewer::brewer.pal(8, "Greens")[4:7]
...
my_colors_greens <- RColorBrewer::brewer.pal(9, "Blues")[4:9]
...
my_colors_lightgreens <- RColorBrewer::brewer.pal(9, "Oranges")[c(4,6)]
...
my_colors_purples <- c(RColorBrewer::brewer.pal(9, "Reds")[2:9],RColorBrewer::brewer.pal(9, "PuRd")[8])
...
my_colors_darkYellow <- RColorBrewer::brewer.pal(9, "Purples")[5:9]
