...
# Selection of edges with density at 0.002
...
set.seed(123)
res <- DIANE::test_edges(mat, normalized_counts = grouped_counts, density = 0.002,
                         nGenes = nGenes, 
...
ggsave(file="volcano_plot_cor_NRT2.1_top10modules.jpg", width=10, height=5)
