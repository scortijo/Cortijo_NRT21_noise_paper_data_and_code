...
filter(All_reps_luc_norm, KNO3=="1mM", expt%in%c("AV05", "AV12_rep1", "AV26_rep1","AV28", "SC15", "SC21")) %>% 
  ...
  theme(legend.text=element_text(size=16),legend.title = element_text(size=16, face="bold"), 
        axis.text=element_text(size=16), axis.title=element_text(size=15.8),
        plot.title = element_text(size=19.5,face="bold"),
        panel.background = element_rect(fill = "white", colour = "grey50"),
...
ggsave("Correlation_scondaryRootDensity_lucSignal_1mM_6reps.jpg", width=5.3, height = 4.7)
