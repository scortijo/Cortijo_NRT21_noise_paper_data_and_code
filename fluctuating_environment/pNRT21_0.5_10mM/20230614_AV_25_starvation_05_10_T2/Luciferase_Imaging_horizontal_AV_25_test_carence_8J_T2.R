...
setwd("/Users/vettoral/Documents/luciferase_imaging_horizontal/AV_25.1_pNRT21_carence/20230614_AV_25_starvation_05_10_T2/")
getwd()
...
testbox <- read.table("AV_25_20230612_test_carence_8J_T2.txt",
                     header=TRUE, sep='\t') %>% 
...
ggsave("compilation_DIFFERENCE_PLATE_AV_25.1_8j_T2.jpg")

######### Luciferase signal Raw integrated density #########


luc <- read.table("AV_25_20230612_test_carence_8J_T2.txt",
                  header=TRUE, sep='\t') %>% 
  mutate(KNO3=factor(KNO3, levels = c("0.5mM->10mM","0.5mM->0.5mM", "10mM->0.5mM", "10mM->10mM")))
...
ggsave("Luciferase_signal_AV_25.1_8J_T2.jpg")
...
ggsave("Meannorm_data_length_norm_AV_25.1_8j_T2.jpg")
...
ggsave("RawIntDen_normBackg_normLen_AV_25.1_8J_T2.jpg")
...
ggsave("length_AV_25.1_8J_T2.jpg")
