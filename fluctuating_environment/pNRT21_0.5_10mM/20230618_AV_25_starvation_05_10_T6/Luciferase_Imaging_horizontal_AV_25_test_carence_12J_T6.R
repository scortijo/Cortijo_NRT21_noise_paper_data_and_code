...
setwd("/Users/alex6/Desktop/AV_25.1_pNRT21_carence/20230618_AV_25_starvation_05_10_T6/")
getwd()
...
testbox <- read.table("AV_25_test_carence_12J_T6.txt",
                     header=TRUE, sep='\t') %>% 
...
ggsave("compilation_DIFFERENCE_PLATE_AV_25.1_12j_T6.jpg")

######### Luciferase signal Raw integrated density #########


luc <- read.table("AV_25_test_carence_12J_T6.txt",
                  header=TRUE, sep='\t') %>% 
  mutate(KNO3=factor(KNO3, levels = c("0.5mM->10mM","0.5mM->0.5mM", "10mM->0.5mM", "10mM->10mM")))
...
ggsave("Luciferase_signal_AV_25.1_12J_T6.jpg")
...
ggsave("Meannorm_data_length_norm_AV_25.1_12j_T6.jpg")
...
ggsave("RawIntDen_normBackg_normLen_AV_25.1_12J_T6.jpg")
...
ggsave("length_AV_25.1_12J_T6.jpg")
