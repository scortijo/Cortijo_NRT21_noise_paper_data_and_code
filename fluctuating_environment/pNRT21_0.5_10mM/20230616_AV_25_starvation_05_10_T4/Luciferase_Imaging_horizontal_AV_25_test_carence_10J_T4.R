...
setwd("/Users/vettoral/Documents/luciferase_imaging_horizontal/AV_25.1_pNRT21_carence/20230616_AV_25_starvation_05_10_T4/")
getwd()
...
testbox <- read.table("AV_25_test_carence_10J_T4.txt",
                     header=TRUE, sep='\t') %>% 
...
ggsave("compilation_DIFFERENCE_PLATE_AV_25.1_10j_T4.jpg")

######### Luciferase signal Raw integrated density #########


luc <- read.table("AV_25_test_carence_10J_T4.txt",
                  header=TRUE, sep='\t') %>% 
  mutate(KNO3=factor(KNO3, levels = c("0.5mM->10mM","0.5mM->0.5mM", "10mM->0.5mM", "10mM->10mM")))
...
ggsave("Luciferase_signal_AV_25.1_10J_T4.jpg")
...
ggsave("Meannorm_data_length_norm_AV_25.1_10j_T4.jpg")
...
ggsave("length_AV_25.1_10J_T4.jpg")
